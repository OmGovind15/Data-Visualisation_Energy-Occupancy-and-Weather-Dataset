...
file_path = r"C:\Users\91878\Downloads\energy_dataset\energy_dataset\acad_build_mains.csv"
...
plt.title('Academic Main Supply - Average Power Consumption by Hour')
plt.legend()
plt.show()