...
file_path = r'C:\Users\91878\Downloads\energy_dataset\energy_dataset\boys_hostel_mains.csv'
...
plt.title('Boys Hostel Main Supply - Average Power Consumption by Hour')
plt.legend()
plt.show()
