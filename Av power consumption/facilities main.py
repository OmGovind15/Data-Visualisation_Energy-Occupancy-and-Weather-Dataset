...
file_path = r"C:\Users\91878\Downloads\energy_dataset\energy_dataset\facilities_build_mains.csv"
...
plt.title('facilitiese main - Average Power Consumption by Hour')
plt.legend()
plt.show()