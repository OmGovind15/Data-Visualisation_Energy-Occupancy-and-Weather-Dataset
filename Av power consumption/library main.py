...
file_path = r"C:\Users\91878\Downloads\energy_dataset\energy_dataset\library_build_mains.csv"
...
plt.title('library building main - Average Power Consumption by Hour')
plt.legend()
plt.show()