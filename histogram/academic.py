...
non_zero_data = selected_data[selected_data['power_kw'] > 0]
bin_edges = np.arange(int(non_zero_data['power_kw'].min()) - 0.5, int(non_zero_data['power_kw'].max()) + 1.5, 1)
plt.figure(figsize=(12, 6))
plt.hist(non_zero_data['power_kw'], bins=bin_edges, edgecolor='black')
plt.xticks(np.arange(0, 10.1, 2.5))
plt.yticks([50000, 100000, 150000])
plt.xlim(0, 10)
plt.ylim(0, 200000)
